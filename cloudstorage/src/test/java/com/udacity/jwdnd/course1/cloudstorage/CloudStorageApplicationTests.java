...
class CloudStorageApplicationTests {
	...
	/**
	 * Test signs up a new user, logs that user in, verifies that they can access the home page,
	...
	public void testLogout(){
		...
		doMockSignUp("OKHTI","HANINA","BAHIA","123");
		doLogIn("BAHIA", "123");
		driver.findElement(By.id("logoutBtn")).click();
		Assertions.assertEquals("http://localhost:" + this.port + "/login", driver.getCurrentUrl());

		// Verify the home page is no longer accessible after logout.
	...
	@Test
	public void testAddingEditingDeletingNotes(){
	...
	@Test
	public void testAddingEditingDeletingCredentials(){
		WebDriverWait webDriverWait = new WebDriverWait(driver, 10);
		// Create a test account
		doMockSignUp("Testing","Credentials","credentials","123");
		doLogIn("credentials", "123");

		Credentials credentials = new Credentials(webDriverWait, driver);
